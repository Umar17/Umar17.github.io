...
<figure>
  ...
  <figcaption> The Bosphorus Strait is a significant waterway and a continental boundary between Asia and Europe.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Taksim Square is considered the heart of modern Istanbul</figcaption>
</figure>
...
<figure>
  <img src="/assets/img/IMG_E0562.jpg" alt="Golden Horn" style="max-width: 100%; height: auto;" />
  <figcaption>Golden Horn is a major waterway and the primary inlet of the Bosphorous strait</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>One of the most beautiful things about Istanbul is these cute friends.</figcaption>
</figure>
...
<div style="padding: 15px; border-radius: 5px; border-color: coral;">
  <i>
I’ve only shared a handful of my experiences in Istanbul—there’s so much more to talk about. Honestly, to cover it all, I’d probably have to write a whole book. There are still plenty of things I want to dive into, but I need to do a bit more digging first—like the history behind certain events, buildings, and the holy relics at the Topkapı Palace Museum. I’ll try to write separate "essays" on those.
  </i>
</div>
